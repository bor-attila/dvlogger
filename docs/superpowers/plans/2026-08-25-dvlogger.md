...
- Java 21, Vert.x `4.5.10`, Maven; package root `hu.dvlogger`.
...
backend/pom.xml
backend/Dockerfile
backend/src/main/java/hu/dvlogger/
...
backend/src/test/java/hu/dvlogger/...  mirrors main
frontend/  (Nuxt 3)
...
**Files:**
- Create: `backend/pom.xml`, `backend/src/main/java/hu/dvlogger/Config.java`, `backend/src/main/java/hu/dvlogger/Main.java`, `backend/src/main/java/hu/dvlogger/api/ApiVerticle.java`, `.gitignore`
- Test: `backend/src/test/java/hu/dvlogger/ConfigTest.java`, `backend/src/test/java/hu/dvlogger/api/HealthTest.java`
      ...
      <plugin>
        ...
        <executions><execution><phase>package</phase><goals><goal>shade</goal></goals>
          <configuration>
            ...
            <transformers>
              <transformer implementation="org.apache.maven.plugins.shade.resource.ManifestResourceTransformer"><mainClass>hu.dvlogger.Main</mainClass></transformer>
...
`backend/src/test/java/hu/dvlogger/ConfigTest.java`:
```java
package hu.dvlogger;
...
`backend/src/main/java/hu/dvlogger/Config.java`:
```java
package hu.dvlogger;
...
`backend/src/test/java/hu/dvlogger/api/HealthTest.java`:
```java
...
`backend/src/main/java/hu/dvlogger/api/ApiVerticle.java` (the three nullable store params are wired in Tasks 9–10; keep the signature now so later tasks don't change the constructor):
```java
package hu.dvlogger.api;
...
`backend/src/main/java/hu/dvlogger/store/MongoStore.java`: `package hu.dvlogger.store; public class MongoStore { }`
`backend/src/main/java/hu/dvlogger/store/ArchiveStore.java`: `package hu.dvlogger.store; public class ArchiveStore { }`
`backend/src/main/java/hu/dvlogger/store/ManticoreIndex.java`: `package hu.dvlogger.store; public class ManticoreIndex { }`

`backend/src/main/java/hu/dvlogger/Main.java`:
```java
package hu.dvlogger;
...
**Files:**
- Create: `backend/src/main/java/hu/dvlogger/model/LogEntry.java`, `backend/src/main/java/hu/dvlogger/ingest/parser/LogParser.java`, `backend/src/main/java/hu/dvlogger/ingest/parser/TextParser.java`
- Test: `backend/src/test/java/hu/dvlogger/model/LogEntryTest.java`, `backend/src/test/java/hu/dvlogger/ingest/parser/TextParserTest.java`
...
**Files:**
- Create: `ingest/parser/JsonParser.java`, `ingest/parser/GelfParser.java`, `ingest/parser/AutoParser.java`, `ingest/parser/Parsers.java` (all under `backend/src/main/java/hu/dvlogger/`)
- Test: `backend/src/test/java/hu/dvlogger/ingest/parser/JsonParserTest.java`, `GelfParserTest.java`, `AutoParserTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/ingest/GelfChunkAssemblerTest.java`, `ReceiverVerticlesTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/store/MongoStoresTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/store/ManticoreIndexTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/store/WriterVerticleTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/store/RetentionVerticleTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/api/AuthAndIngestTest.java`
...
- Test: `backend/src/test/java/hu/dvlogger/store/SearchQueryTest.java`, `backend/src/test/java/hu/dvlogger/api/SearchApiTest.java`
...
Run backend: `cd backend && AUTH_USER=admin AUTH_PASSWORD=admin MONGO_URL=mongodb://localhost:27017/dvlogger MANTICORE_HOST=localhost mvn -q compile exec:java -Dexec.mainClass=hu.dvlogger.Main` (needs local mongo+manticore: `docker run -d -p 27017:27017 mongo:7` and `docker run -d -p 9306:9306 manticoresearch/manticore:6.3.6`). Run `cd frontend && npm run dev`, open http://localhost:3000 → redirected to /login; wrong password shows error; correct → "/" shows "logs". Also run `npm run generate` and confirm `frontend/.output/public/index.html` exists.
